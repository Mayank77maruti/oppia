...
Oppia is an online learning tool that enables anyone to easily creatand share interactive activities (called 'explorations'). These actvities simulate a one-on-one conversation with a tutor, enabling students to learn by doing while getting feedback.
